...
public class DBUtil {
    ...
    private static final String driverClass = SetSystemProperty.getKeyValue("driverClass");
    private static final String jdbcUrl =SetSystemProperty.getKeyValue("jdbcUrl");
    private static final String user = SetSystemProperty.getKeyValue("user");
    private static final String password = SetSystemProperty.getKeyValue("password");
