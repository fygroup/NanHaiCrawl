...
import landsea.com.save.TyphoonStateSave;
 ...
 */
public class Receive_typhoonList extends Thread{
    @Override
    public void run() {
        String receiveStr = null;
        try {
            DatagramSocket socket = new DatagramSocket(8814);//如果有指定的接收数据的本地端口，则填入本地端口号；没有则不用
            ...
            while (true){
                ...
                new TyphoonStateSave().saveStopTyphoon(msg);
            }
